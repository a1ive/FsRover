...
enum grub_file_type
  {
    ...
    /* Decode virtual disk images (vhd/vhdx/vdi/qcow/vmdk/dmg/isz filters).  */
...
typedef enum grub_file_filter_id
  {
    ...
    GRUB_FILE_FILTER_BZ2IO,
    GRUB_FILE_FILTER_BROTLI,
    GRUB_FILE_FILTER_LZMAIO,
    GRUB_FILE_FILTER_VHD,
    GRUB_FILE_FILTER_VHDX,
    GRUB_FILE_FILTER_VDI,
    GRUB_FILE_FILTER_QCOW,
    GRUB_FILE_FILTER_QED,
    GRUB_FILE_FILTER_VMDK,
    GRUB_FILE_FILTER_DMG,
    GRUB_FILE_FILTER_SPRS,
    GRUB_FILE_FILTER_ASIF,
    GRUB_FILE_FILTER_ISZ,
    GRUB_FILE_FILTER_SPARSE,
    GRUB_FILE_FILTER_PARALLELS,
    GRUB_FILE_FILTER_FFU,
    GRUB_FILE_FILTER_TIB,
    GRUB_FILE_FILTER_TIBX,
    GRUB_FILE_FILTER_PMF,
    GRUB_FILE_FILTER_PMFX,
    GRUB_FILE_FILTER_NTFSCLONE,
    GRUB_FILE_FILTER_PARTCLONE,
    GRUB_FILE_FILTER_SNA,
    GRUB_FILE_FILTER_CDIMAGE,
    GRUB_FILE_FILTER_GHO,
    GRUB_FILE_FILTER_TBI,
    GRUB_FILE_FILTER_EWF,
    GRUB_FILE_FILTER_MAX,
    GRUB_FILE_FILTER_COMPRESSION_FIRST = GRUB_FILE_FILTER_GZIO,
    GRUB_FILE_FILTER_COMPRESSION_LAST = GRUB_FILE_FILTER_LZMAIO,
    GRUB_FILE_FILTER_VDISK_FIRST = GRUB_FILE_FILTER_VHD,
    GRUB_FILE_FILTER_VDISK_LAST = GRUB_FILE_FILTER_EWF,
